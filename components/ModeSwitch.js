...
/* Two ways to be in Zurvo: a rider looking for a trip, or an organiser running
   ...
   Picking Organiser routes to the hub (/organiser), where they manage every trip
   they run — publish, edit, post live updates, finish — rather than dropping
   straight into a blank create form. */
export default function ModeSwitch({ active }) {
  return (
    <div className="mode" role="tablist" aria-label="Rider or organiser">
      ...
      <Link href="/organiser/" role="tab" aria-selected={active === 'organiser'} className="mode-tab">
        Organiser
      </Link>
